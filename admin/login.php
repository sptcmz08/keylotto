...
<head>
    ...
    <title>Admin Login - คีย์หวย</title>
    ...
    <div class="w-full max-w-md mx-4">
        <div class="bg-white rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-500 to-emerald-600 px-8 py-8 text-center">
                ...
                <p class="text-white/70 text-sm mt-1">ระบบจัดการหวย - Admin</p>
            </div>
        ...
        <p class="text-center text-white/50 text-xs mt-6">&copy; <?= date('Y') ?> คีย์หวย Admin System</p>
    </div>
